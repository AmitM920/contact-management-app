...
//   const login =()=>{
//     if(Email.current.value ==="user@gmail.com" && pass.current.value==="1234"){
...
//         <input type="password" class="form-control" ref={pass} id="exampleInputPassword1" placeholder="Password"/>
//       </div>
